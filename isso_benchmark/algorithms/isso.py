"""
Improved Stadium Spectators Optimizer (ISSO)
Enhancements: Adaptive P(t) + Levy Flight (Mantegna)
"""
import numpy as np
...
class ISSO:
    def __init__(self, func, dim, lb, ub, N=30, max_iter=500, seed=None,
                 P_max=0.8, P_min=0.2, alpha=0.01, lam=1.5):
        self.func = func
        self.dim = dim
    ...
    def run(self):
        ...
        # Pre-compute search-space range for Lévy scaling
        ...
        for t in range(1, self.max_iter + 1):
            ...
            # Decaying Lévy intensity: strong exploration early → fine-tuning late
            ...
            for i in range(self.N):
                ...
                # FIX: per-particle Lévy step (each particle gets its own)
                L = self._levy_step(rng)
